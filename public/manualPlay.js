...
const view = h /* syntax: html */ `
    <section>
        <div class="searchBox">
            ...
            <button #searchmovies type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary">Search</button>
            <button #stopsearch type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Stop</button>
        </div>
        <div>
...
function ManualPlay(state) {
    ...
    const update = () => {
        console.log('Rendered ManualPlay')
    }
    update()
