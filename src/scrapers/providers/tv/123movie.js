...
/*
       ...
       THIS WILL NOT FUNCTION UNTIL THE TV SHOW TITLE
       IS NO LONGER SENT WITH THE YEAR.
...
async function _123movie(req, sse){
    ...
    async function scrape(url){
        ...
        $("article.item").toArray().forEach(element => {
            ...
            if(contentTitle === showTitle) videoPage = contentPage;
        });
